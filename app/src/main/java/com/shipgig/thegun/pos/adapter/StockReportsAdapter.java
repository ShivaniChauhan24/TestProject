...
public class StockReportsAdapter extends RecyclerView.Adapter<StockReportsAdapter.ViewHolder> {
    ArrayList<StockReportsModel>reports;
    Context context;

    public StockReportsAdapter(ArrayList<StockReportsModel> tReports, Context context) {
    ...
    @Override
    public StockReportsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.stock_reports_details, parent, false);
        return new StockReportsAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(StockReportsAdapter.ViewHolder holder, int position) {
