...
public class TransactionReportsActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storeID = Sharepreference.getSharedPreferenceInt(TransactionReportsActivity.this,"storeID",0);
...
//        initCustomSpinner();
    ...
    private void seeExpensedataAll() {
        try {
            ...
            cursor = mydatabase.rawQuery("SELECT discount,totalAmount,CGST,itemCount,transaction_ID,createdOn,customer_name,paymentMode,custUser_ID from tbl_transaction where isDeleted=0 AND store_ID="+storeID, null);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(TransactionReportsActivity.this, MainActivity.class);
